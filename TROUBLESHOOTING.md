...
- **Fn+Option model toggle does nothing**: same permission as push-to-talk — Terminal needs Input Monitoring. Some keyboards never expose Fn to apps; set `"hotkeys": {"toggle_model": "ctrl+option+m"}` in backtalk.json and restart.
